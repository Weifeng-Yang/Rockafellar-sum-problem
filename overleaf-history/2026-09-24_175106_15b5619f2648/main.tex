...
In this section, we derive further consequences of the general construction theorem. Specifically, we compute exact Fitzpatrick values, extend the counterexamples to further Banach spaces, and construct counterexamples with normal-cone operators and with second operators having full domain and bounded range.  
...
The radial bounds give a further choice of the second operator whose entire range is bounded.
