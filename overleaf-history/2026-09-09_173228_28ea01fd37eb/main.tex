...
In both examples, the second operator is a bounded linear monotone operator of rank one defined on the whole space. 
...
% Since Rockafellar's theorem covers reflexive spaces, a counterexample must be constructed in a nonreflexive space. 
