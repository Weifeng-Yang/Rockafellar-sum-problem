...
We further determine the domain geometry and exact radial bounds of the constructed operators, characterize reflexivity by a fixed rank-one test in two classical classes of Banach spaces, identify maximal monotone extensions under surjective pullback, and compute exact Fitzpatrick identities. The appendices further extend these constructions to additional parameter and product families, nonlinear scalar and strictly monotone second operators, normal-cone and subdifferential partners, and examples with prescribed radial bounds. 
