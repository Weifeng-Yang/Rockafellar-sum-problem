...
\]
In fact, $Q\mathcal R(La)=La$, and any other preimage differs by an element of $\ker Q$. For the fixed enumeration $(q_n)$, this formula specifies the entire graph of $T$ through the prescribed map $\mathcal R$ and the parameters $a\in D$ and $v\in\ker Q$.
