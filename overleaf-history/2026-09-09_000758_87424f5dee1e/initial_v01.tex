...
but their sum is not maximally monotone. The examples are defined on $c_0$ and
...
\section*{Use of AI}
The author directed the counterexample search and the development of a general construction theorem characterizing maximality and showing when
addition of an everywhere-defined rank-one monotone operator produces a nonmaximal sum. Under this direction, GPT-5.6 Sol developed explicit formulas and proof arguments for the counterexamples on $c_0$ and standard $\ell^1$, and assisted with literature checks, adversarial review and exposition. 
