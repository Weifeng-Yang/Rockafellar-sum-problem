...
(4) We derive structural consequences for maximal monotonicity and the constructed operators (Section~\ref{sec:corollaries}). We determine the weighted families' domain closures, boundary estimates, meagreness of the domains and exact radial bounds. We also characterize reflexivity by a rank-one test for Banach lattices and spaces with an unconditional Schauder basis, identify all maximal monotone extensions under surjective pullback, and compute the exact difference between a Fitzpatrick value of the sum and the corresponding minimum over dual decompositions. Further results in the appendices characterize actual convex hulls, distinguish extension of the auxiliary curve from extension of the operator graph, and give Fitzpatrick and quotient-norm formulas under pullback. We also provide additional families of counterexamples with distinct structural constructions. 
