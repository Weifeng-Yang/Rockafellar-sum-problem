...
converges in $\ell^2$ to $(1/(4n))_{n\ge1}\notin\ell^1$.
...
summable and $\eta=(1/(4n))_{n\ge1}$ is not,
...
For every $(u,Q^*a)\in\gra\mathcal T$, $\|u\|_1\ge\|Qu\|_\infty>1/2$ and
...
\end{proposition}
\begin{proof}
Use $a_n^\pm=a^{\pm(1+1/n)}$ and $x_n^\pm=La_n^\pm$. These graph points
...
$-1/(4b)$. For every $\epsilon>0$, only finitely many coordinates of
...
Both $0$ and $3e/2$ belong to $\dom\widetilde M$, since
$x_2+\mathcal S0=x_2$ and $x_2+\mathcal S(3e/2)=-x_2$.
