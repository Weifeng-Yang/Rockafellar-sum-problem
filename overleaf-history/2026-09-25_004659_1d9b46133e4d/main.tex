...
The construction theorem yields a counterexample whenever its hypotheses and maximality criterion are satisfied. The next theorem allows this pair to be transferred to any Banach space admitting a bounded linear surjection onto the construction space.
