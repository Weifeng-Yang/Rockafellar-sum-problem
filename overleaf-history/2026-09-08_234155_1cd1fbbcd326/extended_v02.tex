...
\section*{Use of AI}
The author led the research strategy, directed the extraction of a general
structural theorem from the counterexample on $c_0$, challenged incomplete
arguments, and selected the counterexamples on $c_0$ and standard $\ell^1$
for this paper. Under the author's direction, GPT-5.6 Sol assisted with
candidate constructions, proof development, literature checks, adversarial
review and exposition, and with Lean formalization of the counterexample
on $c_0$ and the general pullback lemma. The author determined the scope
and presentation of the results and retains responsibility for the
manuscript and all submission decisions.
